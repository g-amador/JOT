...
import static jot.manager.ai.AbstractPathFindersManager.PathFinder.JUMP_POINT_SEARCH;
...
import static jot.manager.ai.AbstractPathFindersManager.PathFinder.THETA_STAR;
...
public class GameMain extends Game {
    ...
    public GameMain(String pId) {
        ...
        if (frameworkOptions.get("usePathFinders")) {
            ...
            pfm.setPathfinder2use(THETA_STAR);
            pfm.setPathfinder2use(JUMP_POINT_SEARCH);
    ...
    public void gameInit() {
        ...
        if (null == getProperty("JOT.scenerotate")) {
            ...
            if (frameworkOptions.get("useKeyBoard")) {
                ...
                text.setTextLine("9 key - toggle on/off show influence map.");
                        ...
                        if (frameworkOptions.get("usePathFinders")) {
                            ...
                            if (frameworkOptions.get("useInfluenceMaps")
                                ...
                                if (frameworkOptions.get("_31x31")) {
                                    ...
                                    //im.addPropagator(new Vector3D(15, 0, 15), -(float) sqrt(5));
                                    //im.addPropagator(new Vector3D(15, 0, 15), influenceAttractor);
                                    //im.addPropagator(new Vector3D(15, 0, 15), -(float) sqrt(20));
                                    //Repellers (propagator center is a local maximum)
                                    //im.addPropagator(new Vector3D(15, 0, 15), (float) sqrt(5));
                                    //im.addPropagator(new Vector3D(15, 0, 15), influenceRepeller);
                                    im.addPropagator(new Vector3D(15, 0, 15), (float) sqrt(20));
                                } else if (frameworkOptions.get("_52x52")) {
                                    //Attractors (propagator center is a local minimum)
                                    im.addPropagator(new Vector3D(36, 0, 34), influenceAttractor);
                                    //im.addPropagator(new Vector3D(36, 0, 34), influenceAttractor);
                                    //im.removePropagator(new Vector3D(36, 0, 34), influenceAttractor);
                                    //im.addPropagator(new Vector3D(14, 0, 8), influenceAttractor);
                                    //Repellers (propagator center is a local maximum)
                                    //im.addPropagator(new Vector3D(36, 0, 39), influenceRepeller);
                                    //im.addPropagator(new Vector3D(36, 0, 39), influenceRepeller);
                                    //im.removePropagator(new Vector3D(36, 0, 39), influenceRepeller);
                                    im.addPropagator(new Vector3D(16, 0, 17), influenceRepeller);
                                } else if (frameworkOptions.get("usePathFindersLowLevelGraph")) {
                                    ...
                                    //reset visited
                                    boolean usingPathFindersResetVisited
                                            = frameworkOptions.get("usePathFindersResetVisited");
                                    frameworkOptions.put("usePathFindersResetVisited", true);
                                    pfm.setPrimaryAgent(target);
                                    pfm.findPath();
                                    pfm.setPrimaryAgent(sceneManager.getPlayer(playerId));
                                    frameworkOptions.put("usePathFindersResetVisited",
                                            usingPathFindersResetVisited);

                                    //set back to true if false the path finders node removal adaptivity test.
                                    ...
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "arena2.js");
                                } else if (frameworkOptions.get("useBrc202d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "brc202d.js");
                                } else if (frameworkOptions.get("useBrc203d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "brc203d.js");
                                } else if (frameworkOptions.get("useBrc204d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "brc204d.js");
                                } else if (frameworkOptions.get("useDen011d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "den011d.js");
                                } else if (frameworkOptions.get("useDen500d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "den500d.js");
                                } else if (frameworkOptions.get("useDen501d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "den501d.js");
                                } else if (frameworkOptions.get("useDen602d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "den602d.js");
                                } else if (frameworkOptions.get("useHrt201n")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "hrt201n.js");
                                } else if (frameworkOptions.get("useLak304d")) {
                                    im.loadInfluenceMap("assets/HOG2/DragonAgeOrigins/map.zip", "lak304d.js");
                                } //Warcraft III maps
                                else if (frameworkOptions.get("useBattleground")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "battleground.js");
                                } else if (frameworkOptions.get("useBlastedlands")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "blastedlands.js");
                                } else if (frameworkOptions.get("useDivideandconquer")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "divideandconquer.js");
                                } else if (frameworkOptions.get("useDragonfire")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "dragonfire.js");
                                } else if (frameworkOptions.get("useFrostsabre")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "frostsabre.js");
                                } else if (frameworkOptions.get("useGardenofwar")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "gardenofwar.js");
                                } else if (frameworkOptions.get("useHarvestmoon")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "harvestmoon.js");
                                } else if (frameworkOptions.get("useIsleofdread")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "isleofdread.js");
                                } else if (frameworkOptions.get("useThecrucible")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "thecrucible.js");
                                } else if (frameworkOptions.get("useTranquilpaths")) {
                                    im.loadInfluenceMap("assets/HOG2/WarcraftIII/map.zip", "tranquilpaths.js");
                                }
    ...
    public void gameProcessInput() {
        ...
        if (state == INITIALIZED || state == PLAYING) {
            ...
            if (this.keyBoard.isDetecting("9")) {
                frameworkOptions.put("useInfluenceMaps",
                        !frameworkOptions.get("useInfluenceMaps"));
                Thread thread = new Thread("Recalculating path") {
                    @Override
                    public void run() {
                        sbms.get(playerId).setPath(null);
                        if (!frameworkOptions.get("_31x31")) {
    ...
    public void gameRender(GL2 gl) {
        ...
        switch (state) {
            ...
            case PLAYING:
                ...
                if (frameworkOptions.get("usePathFinders")
                        && frameworkOptions.get("useInfluenceMaps")
                        && pfm.getInfluenceMap() != null) {
                    pfm.getInfluenceMap().render(gl);
                }
                break;
            case PAUSED:
                //......

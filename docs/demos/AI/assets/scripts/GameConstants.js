...
new GameConstant("usePathfindersBestNeighborSearchPrioritized", false);
new GameConstant("usePathfindersBestNeighborSearchSubPaths", false);
new GameConstant("useInfluenceMaps", true);
new GameConstant("useInfluenceMapsDebug", false);
new GameConstant("useInfluenceMapsNormalized", true);
new GameConstant("useInfluenceMapsAdaptivityTest", false);
new GameConstant("useInfluenceMapsNegativeValuedAttractors", false);
new GameConstant("useInfluenceMapsRiskAdversePathfinding", true);
new GameConstant("useInfluenceMapsConstraintAwareNavigation", true);
...
new GameConstant("showGraphDoorNodesElevated", true);

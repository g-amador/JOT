 ...
 *
 * Based on example code by Stefan Gustavson (stegu@itn.liu.se). Optimizations
 ...
 */
public class Simplex extends AbstractNoiseGenerator {  // Simplex noise in 2D, 3D and 4D

    static final Logger log = getLogger("SimplexNoiseGenerator");
     ...
     *
     * @param x
     * @return faster (int)Math.floor(x).
     */
    ...
    public static double noise(double x, double y) {
        ...
        int ii = i & 255;
        int jj = j & 255;
        int gi0 = permMod12[ii + p[jj]];
        int gi1 = permMod12[ii + i1 + p[jj + j1]];
        int gi2 = permMod12[ii + 1 + p[jj + 1]];
    ...
    public static double noise(double x, double y, double z) {
        ...
        int jj = j & 255;
        int kk = k & 255;
        int gi0 = permMod12[ii + p[jj + p[kk]]];
        int gi1 = permMod12[ii + i1 + p[jj + j1 + p[kk + k1]]];
        int gi2 = permMod12[ii + i2 + p[jj + j2 + p[kk + k2]]];
        int gi3 = permMod12[ii + 1 + p[jj + 1 + p[kk + 1]]];
    ...
    public double Noise(double x, double y, double z, double frequency) {
        return this.fBm(x, y, z, frequency);
    }

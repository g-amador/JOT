...
/**
 * Class that implements Best First Search pathfinding algorithm.
 *
 * @author G. Amador {@literal &} A. Gomes
 */
public class BestFirstSearch extends AbstractPathFinder {
     ...
     *
     * [1] Judea Pearl. (1984). "Heuristics: Intelligent Search Strategies for
     * Computer Problem Solving". Addison-Wesley Longman Publishing Co., Inc.,
     * Boston, MA, USA.
     *
        ...
        if (extensionAIOptions.get("usePathFinders")) {
            ...
            while (!open.isEmpty()) {
                ...
                if (current.equals(goal)) {
                    ...
                    this.pathFoundLog("BestFS", solution);
                    return solution;
                }

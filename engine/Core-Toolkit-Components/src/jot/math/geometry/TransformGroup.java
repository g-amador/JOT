...
public class TransformGroup implements Cloneable, Node, Transformable {
    ...
    public void setTranslation(Vector3D translation) {
        ...
        if (!this.boundingVolumes.isEmpty()) {
            for (AbstractBoundingVolume boundingVolume : this.boundingVolumes) {
                if (boundingVolume != null) {
                    log.info(format("%s %s", boundingVolume.max.toString(), boundingVolume.min.toString()));
                    boundingVolume.max = new Vector3D(boundingVolume.max0.toArray()).add(translation);
                    boundingVolume.min = new Vector3D(boundingVolume.min0.toArray()).add(translation);
                    log.info(format("%s %s\n", boundingVolume.max.toString(), boundingVolume.min.toString()));
                }
            }
        }
    }
            ...
            for (AbstractBoundingVolume boundingVolume : this.boundingVolumes) {
                if (boundingVolume != null) {
                    if (boundingVolume.boundingVolumeType != AABB) {
                        ...
                        Vector3D v1 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.min0.toArray()));
                        Vector3D v2 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v3 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v4 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v5 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v6 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v7 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v8 = rotateX(this.rotation.getX(), this.translation, new Vector3D(boundingVolume.max0.toArray()));

                        Vector3D min = this.getMin(this.getMin(this.getMin(this.getMin(this.getMin(this.getMin(this.getMin(v1, v2), v3), v4), v5), v6), v7), v8);
                        Vector3D max = this.getMax(this.getMax(this.getMax(this.getMax(this.getMax(this.getMax(this.getMax(v1, v2), v3), v4), v5), v6), v7), v8);
            ...
            for (AbstractBoundingVolume boundingVolume : this.boundingVolumes) {
                if (boundingVolume != null) {
                    if (boundingVolume.boundingVolumeType != AABB) {
                        ...
                        Vector3D v1 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.min0.toArray()));
                        Vector3D v2 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v3 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v4 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v5 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v6 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v7 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v8 = rotateY(this.rotation.getY(), this.translation, new Vector3D(boundingVolume.max0.toArray()));
            ...
            for (AbstractBoundingVolume boundingVolume : this.boundingVolumes) {
                if (boundingVolume != null) {
                    if (boundingVolume.boundingVolumeType != AABB) {
                        ...
                        Vector3D v1 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.min0.toArray()));
                        Vector3D v2 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v3 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v4 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.min0.getX(), boundingVolume.max0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v5 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v6 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.min0.getY(), boundingVolume.max0.getZ()));
                        Vector3D v7 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.max0.getX(), boundingVolume.max0.getY(), boundingVolume.min0.getZ()));
                        Vector3D v8 = rotateZ(this.rotation.getZ(), this.translation, new Vector3D(boundingVolume.max0.toArray()));

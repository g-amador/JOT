...
/**
 * Abstract class that all noise generators must extend.
 *
...
public abstract class AbstractNoiseGenerator {
     ...
     */
    protected static final int p[] = new int[512], permutation[] = {151, 160, 137, 91,
    ...
    /**
     * The noise multiplication factor.
     */
     ...
     * "Texture {@literal &} Modeling: A Procedural Approach", by David S.
     * Ebert, F. Kenton Musgrave, Darwyn Peachey, Ken Perlin, and Steven Worley,
     * Morgan Kaufmann Publishers, ISBN 1-55860-848-6.
     */
    public void reinitialize() {
        this.reinitialize(currentTimeMillis());
    }
    ...
    /**
     * The final generated noise value for position X,Y,Z that each noise
     ...
     * @param frequency
     *
     * @return generated noise value for position X,Y,Z.
     */
    public abstract double Noise(double x, double y, double z, double frequency);
}

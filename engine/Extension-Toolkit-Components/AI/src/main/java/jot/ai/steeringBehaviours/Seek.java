...
/**
 * Class that implements Craig Reynolds seek steering behavior.
 *
 * @author G. Amador {@literal &} A. Gomes
 */
public class Seek extends AbstractSteeringBehavior {
     ...
     */
    protected Vector3D seek(Vector3D targetPosition) {
        ...
        if (extensionAIOptions.get("useSteeringBehaviors")
            ...
            Vector3D distance = targetPosition.subtract(this.primaryAgent.getPosition());

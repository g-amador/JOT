 ...
 */
public class RayTracerTriangle extends AbstractRayTracerShape {

    static final Logger log = getLogger("RayTracerTriangle");

    static {
        log.setLevel(OFF);
    }

    Vector3D v0, v1, v2, e1, e2;//, temp_normal; //, n0, n1, n2;
     ...
     */
    public RayTracerTriangle(Vector3D v0, Vector3D v1, Vector3D v2,
        ...
        this.normal = crossProduct(this.e1, this.e2).normalize();
